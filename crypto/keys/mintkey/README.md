...
```bash
go test -v --bench github.com/BITCOIVA/Bitcoiva-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/BITCOIVA/Bitcoiva-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/BITCOIVA/Bitcoiva-sdk/crypto/keys/mintkey	12.093s
```
